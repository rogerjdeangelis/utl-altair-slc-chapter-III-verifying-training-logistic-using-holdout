    ...
    */
    ...
    Probability |                                                  |
           ...
           0.45 +  add 1 to count each sum of predicted increases  + 0.45
                ...
                |                                H=Holdout         |
           0.40 +     1   Differenc     0.00108                    + 0.40
                |     2   Differenc     0.00226  T=Training        |
                |     3   Differenc     0.00407                    |
                |     4   Differenc     0.00301  D=Difference      |
                |     5   Differenc     0.00365                    |
           0.35 +     6   Differenc     0.00378                    + 0.35
                |     7   Differenc     0.00496                    |
                |     8   Differenc     0.00658           HT       |
                |     9   Differenc     0.00971                    |
                |    10   Differenc    -0.03911                    |
           0.30 +                                                  + 0.30
                |     1   Holdout       0.01613 Apply logistic     |
                |     2   Holdout       0.03024 equation           |
                |     3   Holdout       0.03226                    |
                |     4   Holdout       0.03427                    |
           0.25 +     5   Holdout       0.04032                    + 0.25
                |     6   Holdout       0.05645                    |
                |     7   Holdout       0.07056                    |
                |     8   Holdout       0.09476                    |
                |     9   Holdout       0.14516                    |
           0.20 +    10   Holdout       0.47984 48% of 1046 Bentley+0.20
                |                               in this decile     |
                |     1   Training      0.01721                    |
                |     2   Training      0.03250                    |
          ...
          Plot of Probability*Decile$ltr
                ...
                ---+----+----+----+----+----+----+----+----+----+---
    Probability |                                                  |
                | Differences using Ranked Score                   |
           0.50 +                                                  +  0.50
                | Decile    Sample    Probability                  |
                |                                                  |
                |    1    Difference    0.00012                    |
           0.45 +    2    Difference    0.00820                 H  +  0.45
                |    3    Difference   -0.00837                 T  |
                |    4    Difference   -0.02061                    |
                |    5    Difference   -0.01379                    |
           0.40 +    6    Difference    0.00550                    +  0.40
                |    7    Difference    0.01553                    |
                |    8    Difference    0.01558                    |
                |    9    Difference    0.01875                    |
           0.35 +   10    Difference   -0.02092                    +  0.35
                |                                                  |
                |    1    Holdout       0.01806                    |
                |    2    Holdout       0.00903                    |
           0.30 +    3    Holdout       0.03612                    +  0.30
                |    4    Holdout       0.04740                    |
                |    5    Holdout       0.06546                    |
                |    6    Holdout       0.05192                    |
           0.25 +    7    Holdout       0.06772                    +  0.25
                |    8    Holdout       0.09255                    |
                |    9    Holdout       0.15350                    |
                |         Holdout       0.45824 46% using logistic
           0.20 +   10                          equation           +  0.20
                |    1    Training      0.01818                    |
    ...
    */
    ...
    /*---
                ...
                Analysis of Maximum Likelihood Estimates
                                      ...
                                      Standard          Wald      Pr >
    Parameter       DF    Estimate       Error    Chi-Square     ChiSq

    Intercept        1     -7.7577      0.2185     1260.9687    <.0001
    _MARRIED         1      0.5695      0.0540      111.0252    <.0001
    _ACSGENDER       1      0.4752      0.0652       53.0960    <.0001
    _DIVISIONCDE     1      1.3824      0.1758       61.8300    <.0001
    _INCOME          1      0.4241      0.0224      358.1652    <.0001
    _LOANHOME        1      0.2250      0.0332       45.8299    <.0001
    ...
    */
    ...
    data workx.lgs_holfulest;

       set workx.lgs_holdmodel;
    ...
    WORKX.LGS_HOLDEC total obs=30,000
    ...
    ----------------------------------------------------------------
               1   3001  RESPONSE     8.0000000   3001     0.0026658
                         expect       8.0000000   3001     0.0026658

               2   3000  RESPONSE     4.0000000   3000     0.0013333
                         expect      15.0000000   3000     0.0050000

               3   3000  RESPONSE    16.0000000   3000     0.0053333
                         expect      16.0000000   3000     0.0053333

               4   3000  RESPONSE    21.0000000   3000     0.0070000
                         expect      17.0000000   3000     0.0056667

               5   3000  RESPONSE    29.0000000   3000     0.0096667
                         expect      20.0000000   3000     0.0066667

               6   3000  RESPONSE    23.0000000   3000     0.0076667
                         expect      28.0000000   3000     0.0093333

               7   3000  RESPONSE    30.0000000   3000     0.0100000
                         expect      35.0000000   3000     0.0116667

               8   3000  RESPONSE    41.0000000   3000     0.0136667
                         expect      47.0000000   3000     0.0156667

               9   3000  RESPONSE    68.0000000   3000     0.0226667
                         expect      72.0000000   3000     0.0240000

              10   2999  RESPONSE   203.0000000   2999     0.0676892
                         expect     238.0000000   2999     0.0793598
    ----------------------------------------------------------------
    ---*/
    ...
    Frequency|                                  Frequency|
    Row Pct  |       0|       1|  Total Total   Row Pct  |       0|       1|  Total
    ---------+--------+--------+                ---------+--------+--------+
           1 |   6983 |     18 |   7001  3001          1 |   2993 |      8 |   3001
             |  99.74 |   0.26 |                         |  99.73 |   0.27 |
    ---------+--------+--------+                ---------+--------+--------+
           2 |   6966 |     34 |   7000  3000          2 |   2985 |     15 |   3000
             |  99.51 |   0.49 |                         |  99.50 |   0.50 |
    ---------+--------+--------+                ---------+--------+--------+
           3 |   6962 |     38 |   7000  3000          3 |   2984 |     16 |   3000
             |  99.46 |   0.54 |                         |  99.47 |   0.53 |
    ---------+--------+--------+                ---------+--------+--------+
           4 |   6961 |     39 |   7000  3000          4 |   2983 |     17 |   3000
             |  99.44 |   0.56 |                         |  99.43 |   0.57 |
    ---------+--------+--------+                ---------+--------+--------+
           5 |   6954 |     46 |   7000  3000          5 |   2980 |     20 |   3000
             |  99.34 |   0.66 |                         |  99.33 |   0.67 |
    ---------+--------+--------+                ---------+--------+--------+
           6 |   6937 |     63 |   7000  3000          6 |   2972 |     28 |   3000
             |  99.10 |   0.90 |                         |  99.07 |   0.93 |
    ---------+--------+--------+                ---------+--------+--------+
           7 |   6921 |     79 |   7000  3000          7 |   2965 |     35 |   3000
             |  98.87 |   1.13 |                         |  98.83 |   1.17 |
    ---------+--------+--------+                ---------+--------+--------+
           8 |   6894 |    106 |   7000  3000          8 |   2953 |     47 |   3000
             |  98.49 |   1.51 |                         |  98.43 |   1.57 |
    ---------+--------+--------+                ---------+--------+--------+
           9 |   6838 |    162 |   7000  3000          9 |   2928 |     72 |   3000
             |  97.69 |   2.31 |                         |  97.60 |   2.40 |
    ---------+--------+--------+                ---------+--------+--------+
          10 |   6538 |    461 |   6999  2999         10 |   2761 |    238 |   2999
             |  93.41 |   6.59 |                         |  92.06 |   7.94 |
    ---------+--------+--------+                ---------+--------+--------+
    Total       68954     1046    70000 30000   Total       29504      496    30000
    ...
    */
    ...
    Altair SLC
              ...
              CNTACTDEV_    CNTACTDEV_    CNTACTHLD_    CNTACTHLD_    CNTESTDEV_    CNTESTDEV_    CNTESTHLD_    CNTESTHLD_
     Label        0             1             0             1             0             1             0             1

       1          6982            19          2993             8          6983            18          2993             8
       2          6982            18          2996             4          6966            34          2985            15
       3          6971            29          2984            16          6962            38          2984            16
       4          6972            28          2979            21          6961            39          2983            17
       5          6946            54          2971            29          6954            46          2980            20
       6          6940            60          2977            23          6937            63          2972            28
       7          6913            87          2970            30          6921            79          2965            35
       8          6887           113          2959            41          6894           106          2953            47
       9          6820           180          2932            68          6838           162          2928            72
      10          6542           457          2796           203          6538           461          2761           238
    ...
    Middle Observation(5) of table = workx.lgs_cnt - Total Obs 10 16DEC2025:09:49:53
     ...
     cntEstHld_0     N8      2980   *---  PREDICTED COUNTS HLD -4 is HOLDOUT  30,000   response=0 ---;
     cntEstHld_1     N8        20   *---  PREDICTED COUNTS HLD -3 is HOLDOUT  30,000   response=1 ---;
    ...
    WORKX.LGS_PCT total obs=10

             PCTACTDEV_    PCTACTDEV_    PCTACTHLD_    PCTACTHLD_    PCTESTDEV_    PCTESTDEV_    PCTESTHLD_    PCTESTHLD_
    Label        0             1             0             1             0             1             0             1

      1        10.1254        1.8182       10.1262        1.8059       10.1270        1.7208       10.1444        1.6129
      2        10.1254        1.7225       10.1363        0.9029       10.1024        3.2505       10.1173        3.0242
      3        10.1095        2.7751       10.0957        3.6117       10.0966        3.6329       10.1139        3.2258
      4        10.1109        2.6794       10.0788        4.7404       10.0951        3.7285       10.1105        3.4274
      5        10.0732        5.1675       10.0518        6.5463       10.0850        4.3977       10.1003        4.0323
      6        10.0645        5.7416       10.0721        5.1919       10.0603        6.0229       10.0732        5.6452
      7        10.0254        8.3254       10.0484        6.7720       10.0371        7.5526       10.0495        7.0565
      8         9.9877       10.8134       10.0112        9.2551        9.9980       10.1338       10.0088        9.4758
      9         9.8905       17.2249        9.9198       15.3499        9.9168       15.4876        9.9241       14.5161
     10         9.4873       43.7321        9.4597       45.8239        9.4817       44.0727        9.3581       47.9839
    ...
    VAR            TYPE     PERCENT
     ...
     PCTESTHLD_0   N8     10.10032538  *---  PREDICTED PERCENT HLD -4 is HOLDOUT  30,000   response=0 ---;
     PCTESTHLD_1   N8    4.0322580645  *---  PREDICTED PERCENT HLD -3 is HOLDOUT  30,000   response=1 ---;
    ...
    */
    ...
    LABEL           C3    4
     ...
     -- NUMERIC --
    CNTACTDEV_0     N8    6946           TRAINING 0 RESPONSE RANKED BY SCORE
    CNTACTDEV_1     N8    54             TRAINING 1 RESPONSE RANKED BY SCORE

    CNTACTHLD_0     N8    2971           HOLDOUT  0 RESPONSE RANKED BY SCORE
    CNTACTHLD_1     N8    29             HOLDOUT  1 RESPONSE RANKED BY SCORE

    CNTESTDEV_0     N8    6954           TRAINING 0 RESPONSE USING MODELED PROBABITIES DIRECTLY
    CNTESTDEV_1     N8    46             TRAINING 1 RESPONSE USING MODELED PROBABITIES DIRECTLY

    CNTESTHLD_0     N8    2980           HOLDOUT  0 RESPONSE USING MODELED PROBABITIES DIRECTLY
    CNTESTHLD_1     N8    20             HOLDOUT  1 RESPONSE USING MODELED PROBABITIES DIRECTLY

    PCTACTDEV_0     N8    10.073236169   SAME AS ABOVE BUT PERCENT
    PCTACTDEV_1     N8    5.1674641148

    PCTACTHLD_0     N8    10.051764387
    PCTACTHLD_1     N8     6.546275395

    PCTESTDEV_0     N8    10.084984192
    PCTESTDEV_1     N8    4.3977055449

    PCTESTHLD_0     N8     10.10032538
    PCTESTHLD_1     N8    4.0322580645
    ...
    */
    ...
    /*----
    ltr       Method        Decile      Sample      Probability

     D     MODEL PREDICT       1      Difference       0.00108
     D     MODEL PREDICT       2      Difference       0.00226
     D     MODEL PREDICT       3      Difference       0.00407
     D     MODEL PREDICT       4      Difference       0.00301
     D     MODEL PREDICT       5      Difference       0.00365
    ....
     T     RANKED SCORE        6      Training         0.05742
     T     RANKED SCORE        7      Training         0.08325
     T     RANKED SCORE        8      Training         0.10813
     T     RANKED SCORE        9      Training         0.17225
     T     RANKED SCORE       10      Training         0.43732
